...
void _showTipoSheet(BuildContext context, EnsinoController ctrl) {
...
Future<void> _pickDataApresentacao(
    BuildContext context, EnsinoController ctrl) async {
  final isDark = Theme.of(context).brightness == Brightness.dark;
  final fieldBg = isDark ? const Color(0xFF18191B) : AppColors.cardLight;
...
Future<void> _cadastrar(BuildContext context, EnsinoController ctrl) async {
